...
# ╔═╡ fcbeaf6b-d861-4c3f-ae1c-520f6618cf12
using MCMCChains

# ╔═╡ 4af00354-d052-4eb3-b654-0155290c2a20
using Turing
...
#### Task 1. Install Julia (1.9 over greater)
...
# ╔═╡ 3814da47-5a18-4e77-b5ea-e1f5299902b3
 psn_data = rand(psn, 20)
...
Use Turing.jl to infer the unknown parameter $\lambda$ given the simulated data 

* use Gamma as a prior distribution for $\lambda$
...
begin
	...
	a₀ = 0.1
	θ₀ = 0.1
	chain_array =rand(Gamma(a₀ + xsum, 1/(θ₀ + n)), 1000)

end

# ╔═╡ 5bdd8771-21e9-41c6-8638-f527f9315dee
plot(Chains(chain_array))

# ╔═╡ 202c2fe6-83ea-4a65-bea6-a5054d8ea57e
begin

	@model function poisson_infer(data)
		λ ~ Gamma(0.1, 1/0.1)
...
# ╔═╡ 0d7cc97e-15d5-4257-a390-d5f4404ebb55
mcmc_chain = sample(poisson_infer(psn_data), NUTS(), 4000)

# ╔═╡ 8dd09f35-1948-4f50-8110-378a5a3dcbc3
plot(mcmc_chain)
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "a383b83df793cca26b80f489e7866a1897e21c9b"

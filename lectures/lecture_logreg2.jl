...
# ╔═╡ 08de4492-2f8a-4f41-b531-95222d5aef71
ChooseDisplayMode()
...
let
	...
	Plots.plot!(p_bayes_pred, D2[:, 1], D2[:,2], seriestype=:scatter, markersize = 5,  markercolor=2, label="class 2", xlabel=L"x_1", ylabel=L"x_2")
...
manifest_format = "2.0"
project_hash = "28038a3e98b0fba4fc95a830036c6cb2c3c45aaa"

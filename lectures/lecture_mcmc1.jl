...
begin
	gr()
	plot(0:0.02:1, 0:0.02:1, (x,y) -> true_p(x,y), xlabel="θA", ylabel="θB", st=:contour, c=:jet, cbar=false, ratio=1, xlim=[0,1])
end
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "ee18e48542b5e34304bee60fc37b406e79536ea8"
